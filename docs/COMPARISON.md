...
| **Built-in tools** | 52 skills | 12 tools | 0 (Claude Agent SDK) | 9 tools | 17 tools + MCP client |
| **Channels** | 14 + 32 extensions | 10 | 1 (WhatsApp) | 7 | 5 |
...
| **Codebase** | ~465K lines | ~20.6K lines | ~3.4K lines | ~27.4K lines | ~11K lines |
| **Tests** | 949 test files | 222 tests | ~413 assertions | ~700+ tests | 1,314 tests |
...
| Agent swarms / delegation | Multi-agent routing | Subagent manager | Yes (Claude Agent Teams) | No | DelegateTool with tool whitelists |
| Hardware I/O (I2C, SPI) | No | Yes | No | No | No |
...
OpenClaw leads on channel breadth (14+32 extensions). PicoClaw covers Chinese platforms. NanoClaw focuses on WhatsApp. ZeroClaw has 7 channels including iMessage and Matrix. ZeptoClaw has 5 channels plus a generic webhook.
...
| **Complexity** | High (~465K lines) | Low (~20.6K lines) | Minimal (~3.4K lines) | Moderate (~27.4K lines) | Moderate (~11K lines) |
...
| Agent swarms | **NanoClaw** or **ZeptoClaw** | NanoClaw: Claude Agent Teams. ZeptoClaw: DelegateTool |
...
| | OpenClaw | PicoClaw | NanoClaw | ZeroClaw | ZeptoClaw |
|---|---|---|---|---|---|
| **Stage** | Established (160K+ stars) | New (5K+ stars in first week) | New | New | New (v0.3.1) |
